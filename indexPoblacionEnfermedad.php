    ...
    <div class="content">
        <div class="row">
            <div class="box scroll-x color-light">
                ...
                <p style="font-size: small; margin-top: -20px;"> 🡢 <b>Sector:</b> <?= $sectorMostrar ?> 🡢 <b>Comunidad:</b> <?= $comunidadInfo['nombre'] ?> 🡢 <b>Enfermedades: </b><?= $data ?></p>
                <br>
                    ...
                    <div class="paginador">
                        <ul>
                            ...
                            for($i=1; $i <= $total_paginas ; $i++){
                                ...
                                echo '<li><a href="?pagina='.$i.'&b='.$buscar.'&data='.$data.'&comunidad='.$comunidad.'&sector='.$sector.'&enfermedad='.$enfermedad.'&registros='.$total_registros.'">'.$i.'</a></li>';
                                }
                            }
                            ?>
