        ...
        <div class="row">
            <div class="box scroll-x color-light">
                <div class="box-header">
                    <h2>Comunidades</h2>
                    <div>
                        <a href="indexComunidad.php" class="btn color-success text-light"><i class="las la-sync-alt"></i></a>
                        <a href="createComunidad.php" class="btn color-primary text-light">Nueva Comunidad</a>
                    </div>  
                </div>
                <form role="form" name="buscar" id="buscar" method="GET" action="indexComunidad.php" class="search">
                    <label>
