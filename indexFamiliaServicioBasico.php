<?php 
    ...
    //lista
    $resultado = array();
    $resultado = $controlador->listarServicioBasico($desde, $registros_por_pagina,$sector, $comunidad, $id_data, $buscar);
        ...
        <div class="row">
            <div class="box scroll-x color-light">
                <div class="box-header">
                    ...
                    <div>
                        <a href="indexFamiliaServicioBasico.php?comunidad=<?php echo $comunidad ?>&sector=<?php echo $sector ?>&data=<?php echo $data; ?>&id_data=<?php echo $id_data; ?>&registros=<?php echo $total_registros; ?>" class="btn color-success text-light"><i class="las la-sync-alt"></i></a>
                    </div>  
                ...
                <p style="font-size: small; margin-top: -20px;"> 🡢 <strong>Sector:</strong> <?= $sectorMostrar ?> 🡢 <strong>Comunidad:</strong> <?= $comunidadInfo['nombre'] ?> 🡢 <strong>Servicio básico de vivienda: </strong><?= $data ?></p>
                <br>
                <form role="form" name="buscar" id="buscar" method="GET" action="indexFamiliaServicioBasico.php" class="search">
                    <label>
