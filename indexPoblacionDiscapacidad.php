<?php 
    ...
    //lista
    $resultado = array();
    $resultado = $controlador->listarDiscapacidades($desde,$registros_por_pagina,$sector,$comunidad,$discapacidad,$buscar);
        ...
        <div class="row">
            <div class="box scroll-x color-light">
                <div class="box-header">
                    <h2>Reporte de discapacidad</h2>
                    <div>
                        <a href="indexPoblacionDiscapacidad.php?comunidad=<?php echo $comunidad ?>&sector=<?php echo $sector ?>&discapacidad=<?php echo $discapacidad; ?>&registros=<?php echo $total_registros; ?>" class="btn color-success text-light"><i class="las la-sync-alt"></i></a>
                    </div>  
                </div>
                ...
                <div class="box-footer">
                    <div class="paginador">
                        <ul>
                            <li><a href="?pagina=<?php echo 1; ?>&b=<?php echo $buscar; ?>&data=<?php echo $data ?>&comunidad=<?php echo $comunidad ?>&sector=<?php echo $sector ?>&discapacidad=<?php echo $discapacidad; ?>&registros=<?php echo $total_registros; ?>"><i class="las la-angle-double-left"></i></a></li>
                            <li><a href="?pagina=<?php echo $pagina - 1; ?>&b=<?php echo $buscar; ?>&data=<?php echo $data ?>&comunidad=<?php echo $comunidad ?>&sector=<?php echo $sector ?>&discapacidad=<?php echo $discapacidad; ?>&registros=<?php echo $total_registros; ?>"><i class="las la-angle-left"></i></a></li>   
                            <?php 
                            for($i=1; $i <= $total_paginas ; $i++){
                                if($i == $pagina){
                                    echo '<li class="paginaSelect">'.$i.'</li>';
                                }else{
                                echo '<li><a href="?pagina='.$i.'&b='.$buscar.'&data='.$data.'&comunidad='.$comunidad.'&sector='.$sector.'&discapacidad='.$discapacidad.'&registros='.$total_registros.'">'.$i.'</a></li>';
                                }
                            }
                            ?>
                            <li><a href="?pagina=<?php if($pagina < $total_paginas){echo $pagina + 1;}else{echo $pagina;}?>&b=<?php echo $buscar; ?>&data=<?php echo $data ?>&comunidad=<?php echo $comunidad ?>&sector=<?php echo $sector ?>&discapacidad=<?php echo $discapacidad; ?>&registros=<?php echo $total_registros; ?>"><i class="las la-angle-right"></i></a></li>
                            <li><a href="?pagina=<?php echo $total_paginas; ?>&b=<?php echo $buscar; ?>&data=<?php echo $data ?>&comunidad=<?php echo $comunidad ?>&sector=<?php echo $sector ?>&discapacidad=<?php echo $discapacidad; ?>&registros=<?php echo $total_registros; ?>"><i class="las la-angle-double-right"></i></a></li>
                        </ul>
                    </div>
