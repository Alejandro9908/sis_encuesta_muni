<?php 
    ...
    $servicios_medicos = $controladorMedico->listarSelect("SELECT * FROM tbl_servicio_medico;");
        ...
        <div class="row">
            <div class="box color-light">
                ...
                <form role="form" name="edit-form-datos-salud" id="edit-form-datos-salud" method="POST"
                        ...
                        <div class="form-item">
                            <label for="txt_servicio_medico" class="text-gray">Servicios Médicos <span style="color: red;">*</span></label>
