<?php 
    ...
    //lista
    $resultado = array();
    $resultado = $controlador->listarTenencia($desde, $registros_por_pagina,$sector, $comunidad, $id_data, $buscar);
        ...
        <div class="row">
            <div class="box scroll-x color-light">
                <div class="box-header">
                    ...
                    <div>
                        <a href="indexFamiliaTenencia.php?comunidad=<?php echo $comunidad ?>&sector=<?php echo $sector ?>&data=<?php echo $data; ?>&id_data=<?php echo $id_data; ?>&registros=<?php echo $total_registros; ?>" class="btn color-success text-light"><i class="las la-sync-alt"></i></a>
                    </div>  
                ...
                <p style="font-size: small; margin-top: -20px;"> 🡢 <strong>Sector:</strong> <?= $sectorMostrar ?> 🡢 <strong>Comunidad:</strong> <?= $comunidadInfo['nombre'] ?> 🡢 <strong>Tenencia de vivienda: </strong><?= $data ?></p>
                <br>
                <form role="form" name="buscar" id="buscar" method="GET" action="indexFamiliaTenencia.php" class="search">
                    <label>
