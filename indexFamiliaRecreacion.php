    ...
    <div class="content">
        <div class="row">
            <div class="box scroll-x color-light">
                ...
                <p style="font-size: small; margin-top: -20px;"> 🡢 <strong>Sector:</strong> <?= $sectorMostrar ?> 🡢 <strong>Comunidad:</strong> <?= $comunidadInfo['nombre'] ?> 🡢 <strong>Recreacion: </strong><?= $recreacion ?></p>
                <br>
